...
document.addEventListener("DOMContentLoaded", function () {
  ...
  signup_form_check.addEventListener("submit", function (event) {
    ...
    //     // Show a notification to the user that the user already exists
    //     alert('User already exists');
    //   } else if (response.status === 200) {
    //     // Redirect the user to the OTP verification form
    //     app.get('/otp', (req, res) => {
    //       // Here you can render the OTP verification form or perform any other desired action
